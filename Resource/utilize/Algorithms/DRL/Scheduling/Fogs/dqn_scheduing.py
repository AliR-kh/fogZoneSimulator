...
class RunFogScheduling_DQN():
    def __init__(self,resources,tasks):        
        ...
        self.TARGET_UPDATE = 1000         # به‌روزرسانی مکررتر شبکه هدف برای سازگاری بهتر
        self.LR = 5e-5               # نرخ یادگیری معقول برای شبکه کوچک تا متوسط
        self.NUM_EPISODES = 200         # اپیزودهای بیشتر برای پوشش بیشتر وضعیت‌ها
